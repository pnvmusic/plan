...
export const TASK_EVENT_COLOR = '#4aa8ff'
export const TASK_EVENT_ICON = '☑️'
export const eventColor = (e) => e?.task_id ? TASK_EVENT_COLOR : (EV_COLOR[e?.type] || '#6b768f')
export const eventIcon = (e) => e?.task_id ? TASK_EVENT_ICON : (EV_ICON[e?.type] || '📅')
export const eventLabel = (e) => e?.task_id ? 'Task' : (EV_LABEL[e?.type] || 'นัดหมาย')
export const eventTitle = (e) => e?.task_id ? String(e.title || '').replace(/^Deadline:\s*/i, '') : e?.title
